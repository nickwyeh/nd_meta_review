...
compare <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Control.comparison-1, random = list(~ 1 | Study/effectsizeID),
...
retrievaltype <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Retrieval-1, random = list(~ 1 | Study/effectsizeID),
                        tdist = TRUE, data = df_meta)
...
onoffmoderator <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~Simulation.timing-1,random = list(~ 1 | Study/effectsizeID),
                         tdist = TRUE, data = df_meta)
...
freqmoderator <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Frequency-1, random = list(~ 1 | Study/effectsizeID),
                        tdist = TRUE, data = df_meta)
...
hemimod <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Hemisphere-1, random = list(~ 1 | Study/effectsizeID),
                  tdist = TRUE, data = df_meta)
...
memorymod <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Memorystage-1, random = list(~ 1 | Study/effectsizeID), 
...
moderatorpfcpcc <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Cortical.region-1, random = list(~ 1 | Study/effectsizeID),
                          tdist = TRUE, data = df_meta)
summary(moderatorpfcpcc, digits = 3)
anova(moderatorpfcpcc, btt = 1:2)

# check motor threshold 
motor <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~ Intensity-1, random = list(~ 1 | Study/effectsizeID), 
                tdist = TRUE, data = df_meta)
...
onoffFreqinteraction <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~  Frequency:Simulation.timing-1,
...
freqxmti <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~Frequency:Intensity-1, 
...
memoryprocessesmod <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~Memorystage:Hemisphere-1,
                             random = list(~ 1 | Study/effectsizeID), tdist = TRUE, data = df_meta)
...
moderatorinteraction <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~  Retrieval:Cortical.region-1,
                               random = list(~ 1 | Study/effectsizeID), tdist = TRUE, data = df_meta)
...
timingintensity <- rma.mv(df_meta$hedge, df_meta$Sampling.variance, mods = ~  Simulation.timing:Intensity-1, 
                          random = list(~ 1 | Study/effectsizeID), tdist = TRUE, data = df_meta)
...
```{r}
# 
mods_list = c("compare","retrievaltype","onoffmoderator","freqmoderator","hemimod","moderatorpfcpcc","memorymod","motor")
